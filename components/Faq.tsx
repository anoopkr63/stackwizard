...
const FAQS = [
  {
    ...
    a: "No. Paste one numbered block at a time into Terminal (Mac) or Git Bash (Windows) and press Enter. “What each step does” labels every line, and only the final line keeps running — everything before it finishes and exits.",
  },
  {
    q: "What is the smallest thing I can start with?",
    a: "TypeScript + React (Vite) + Plain CSS + npm, everything else left at None — about four commands and one project folder. Add extras later by re-picking; the page regenerates the full sequence around what you already have.",
  },
  {
  ...
  },
  {
    ...
    a: "Change the dropdown and the commands regenerate instantly — nothing is installed by choosing. Your address bar always holds the current setup as a share link, so no pick is permanent. Incompatible pairs (Mongoose without MongoDB, Supabase Auth with Firebase) are hidden or dropped automatically.",
  },
  {
    q: "Does StackWizard touch my machine or need my passwords?",
    a: "Never. This site generates text; every command runs on your machine, by you. API keys go into the .env file the steps create locally — it stays yours, uncommitted, unsent. The generated AI rules even order assistants never to print it.",
  },
  {
